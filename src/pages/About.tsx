    ...
    <div className="max-w-3xl flex flex-col gap-10 mx-auto mt-40 mb-10">
      ...
      <FadeIn>
        <div className="flex flex-col gap-3 items-center text-center text-zinc-600 leading-loose">
          <p>
            I’m a portrait & wedding photographer based in Seattle, WA. I’ve
            been lucky enough to photograph weddings all over the world for over
            15 years.
          </p>
          <p>
          ...
          <p>
            ...
            places I visit. Photography has been such a large part of my life
            for as long as I can remember. I’m so grateful to have been able to
            turn a passion of mine into a career. If you connect with my work, I
            would love to hear more about what you would like to create
            together.{" "}
          </p>
        </div>
      </FadeIn>
